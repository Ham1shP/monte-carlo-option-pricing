...
Control variates are another way to reduce the variance of this method. By using control variates, I showed that you need ~6.95 times fewer simulations to get the same variance. 
